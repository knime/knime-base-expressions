    ...
    List<DynamicNode> stddev() {
        return new AggregationTestUtils.AggregationTestBuilder(BuiltInAggregations.STD_DEV,
            StdDevColumnAggregationImpl::stddevAggregation) //
                ...
                .implDouble("ddof == N", listOf(1.0, 2.0, 3.0), List.of(BOOL(false)), Map.of("ddof", INT(3)), Double.NaN) //
                .implDouble("ddof >= N", listOf(1.0, 2.0, 3.0), List.of(BOOL(false)), Map.of("ddof", INT(4)), Double.NaN) //
