...
final class TemporalParseFormatFunctionTests {
    ...
    List<DynamicNode> parseDate() {
        return new FunctionTestBuilder(TemporalParseFormatFunctions.PARSE_DATE) //
            ...
            .impl("valid locale (de)", List.of(arg("2001-Februar-03"), arg("yyyy-MMMM-dd"), arg("de_DE")), TEST_DATE) //
            ...
            .missingAndWarns("invalid locale format", List.of(arg("2001-02-03"), arg("yyyy-MM-dd"), arg("foobar")),
                ".*malformed.*") //
            .missingAndWarns("invalid locale", List.of(arg("2001-02-03"), arg("yyyy-MM-dd"), arg("aq_XZ")),
                ".*not.*supported.*") //
            .tests();
    }
    ...
    List<DynamicNode> parseTime() {
        return new FunctionTestBuilder(TemporalParseFormatFunctions.PARSE_TIME) //
            ...
            .impl("valid locale (de)", List.of(arg("12:34:56 Februar"), arg("HH:mm:ss MMMM"), arg("de_DE")), TEST_TIME) //
    ...
    List<DynamicNode> parseDateTime() {
        return new FunctionTestBuilder(TemporalParseFormatFunctions.PARSE_DATE_TIME) //
            ...
            .impl("valid locale (de)",
                List.of(arg("2001-Februar-03 12:34:56"), arg("yyyy-MMMM-dd HH:mm:ss"), arg("de_DE")), TEST_DATE_TIME) //
    ...
    List<DynamicNode> parseZonedDateTime() {
        return new FunctionTestBuilder(TemporalParseFormatFunctions.PARSE_ZONED_DATE_TIME) //
            ...
            .impl("missing datetime", List.of(misString())) //
            .impl("valid locale (de)",
                List.of(arg("2001-Februar-03 12:34:56 Europe/Paris"), arg("yyyy-MMMM-dd HH:mm:ss VV"), arg("de_DE")),
    ...
    List<DynamicNode> formatLocalDate() {
        return new FunctionTestBuilder(TemporalParseFormatFunctions.FORMAT_DATE) //
            ...
            .impl("valid locale (de)", List.of(arg(TEST_DATE), arg("dd MMMM yyyy"), arg("de_DE")), "03 Februar 2001") //
    ...
    List<DynamicNode> formatLocalTime() {
        return new FunctionTestBuilder(TemporalParseFormatFunctions.FORMAT_TIME) //
            ...
            .impl("valid locale (de)", List.of(arg(TEST_TIME), arg("a"), arg("de_DE")), "PM") //
            .impl("valid locale (jp)", List.of(arg(TEST_TIME), arg("a"), arg("ja_JP")), "午後") //
