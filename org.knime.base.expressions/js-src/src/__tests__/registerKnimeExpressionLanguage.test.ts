...
import { DEFAULT_BASE_INITIAL_DATA } from "../__mocks__/mock-data";
...
describe("registerKnimeExpressionLanguage", () => {
  it("registers the language", () => {
    registerKnimeExpressionLanguage(DEFAULT_BASE_INITIAL_DATA);
  ...
  it("returns a disposal function that disposes registered providers", () => {
    const dispose = registerKnimeExpressionLanguage(DEFAULT_BASE_INITIAL_DATA);
    dispose();
