...
/**
 * {@link ScriptingService} implementation for the Generic ECharts View.
 *
 * @author Carsten Haubold, KNIME GmbH, Konstanz, Germany
 */
final class JsonEditorScriptingService extends ScriptingService {

    public static final String INPUT_OUTPUT_TYPE_TABLE = "Table";

    JsonEditorScriptingService() {
        // TODO filter out unsupported flow variables
        super(null, t -> true);
    }

    @Override
    public RpcService getJsonRpcService() {
        return new JsonEditorRpcService();
    }

    public final class JsonEditorRpcService extends RpcService {
