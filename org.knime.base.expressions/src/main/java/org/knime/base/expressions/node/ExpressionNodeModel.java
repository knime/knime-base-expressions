...
class ExpressionNodeModel extends NodeModel {
    ...
    private ExpressionNodeSettings m_settings;
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings) {
        if (m_settings != null) {
            DefaultNodeSettings.saveSettings(ExpressionNodeSettings.class, m_settings, settings);
        }
    }

    @Override
    protected void validateSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
        DefaultNodeSettings.loadSettings(settings, ExpressionNodeSettings.class);
    }

    @Override
    protected void loadValidatedSettingsFrom(final NodeSettingsRO settings) throws InvalidSettingsException {
        m_settings = DefaultNodeSettings.loadSettings(settings, ExpressionNodeSettings.class);
    }
