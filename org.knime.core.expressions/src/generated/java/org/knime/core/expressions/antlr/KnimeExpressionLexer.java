...
public class KnimeExpressionLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"IF_KEYWORD", "ELSE_KEYWORD", "IDENTIFIER", "COLUMN_IDENTIFIER", "FLOW_VAR_IDENTIFIER", 
			"FLOW_VARIABLE_ACCESS_START", "COLUMN_ACCESS_START", "ACCESS_END", "COMMA", 
			"BRACKET_OPEN", "BRACKET_CLOSE", "CURLY_OPEN", "CURLY_CLOSE"
		};
	}
