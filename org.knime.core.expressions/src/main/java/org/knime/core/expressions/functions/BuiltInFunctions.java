...
public final class BuiltInFunctions {
    ...
    public static final List<ExpressionFunction> BUILT_IN_FUNCTIONS = List.of( //
        ...
        TemporalFunctions.TIME_DURATION_BETWEEN, //
        TemporalFunctions.DATE_DURATION_BETWEEN, //
        TemporalFunctions.ADD_TIME_DURATION, //
        ...
        TemporalFunctions.HAS_SAME_INSTANT, //
        TemporalFunctions.HAS_SAME_WALL_TIME //
    );
